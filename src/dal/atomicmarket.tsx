import { Sale, SaleSort, SortOrder } from "atomicmarket/build/API/Explorer/Types";
 ...
 */
export function useSales(options: {collection: string, search?: string, page: 1, limit: 40}): UseQueryResult<Array<Sale>>{
